...
## Clock signal
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets  btnr_17_reset]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets  btnr_18_clock]
...
#set_property PACKAGE_PIN W15 [get_ports {sw[a]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {[a]}]
#set_property PACKAGE_PIN V15 [get_ports {[b]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {[b]}]
#set_property PACKAGE_PIN W14 [get_ports {c}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {c}]
#set_property PACKAGE_PIN W13 [get_ports {d}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {d}]
#set_property PACKAGE_PIN V2 [get_ports {b}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {b}]
...
##7 segment display
#set_property PACKAGE_PIN W7 [get_ports {seg_m}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {seg_m}]
#set_property PACKAGE_PIN W6 [get_ports {seg_r}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {seg_r}]
#set_property PACKAGE_PIN U8 [get_ports {seg_r}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {seg_r}]
#set_property PACKAGE_PIN V8 [get_ports {seg_m}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {seg_m}]
#set_property PACKAGE_PIN U5 [get_ports {seg_l}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {seg_l}]
#set_property PACKAGE_PIN V5 [get_ports {seg_l}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {seg_l}]
#set_property PACKAGE_PIN U7 [get_ports {seg_m}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {seg_m}]

#set_property PACKAGE_PIN V7 [get_ports dp]							
	#set_property IOSTANDARD LVCMOS33 [get_ports dp]

set_property PACKAGE_PIN U2 [get_ports {seg_l}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {seg_l}]
set_property PACKAGE_PIN U4 [get_ports {seg_m}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {seg_m}]
set_property PACKAGE_PIN V4 [get_ports {seg_r}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {seg_r}]
...
set_property PACKAGE_PIN T18 [get_ports btnr_18_clock]						
	set_property IOSTANDARD LVCMOS33 [get_ports btnr_18_clock]
#set_property PACKAGE_PIN W19 [get_ports btnL]						
	#set_property IOSTANDARD LVCMOS33 [get_ports btnL]
set_property PACKAGE_PIN T17 [get_ports btnr_17_reset]						
	set_property IOSTANDARD LVCMOS33 [get_ports btnr_17_reset]
